...
public interface PostRepository extends JpaRepository<Post, String>{
    ...
    @Query("select p from Post p where p.status='Approved' and p.expireDate > :date and p.priority = 3")
    Page<Post> findAllByPriority(Pageable pageable,@Param("date") LocalDate today);
