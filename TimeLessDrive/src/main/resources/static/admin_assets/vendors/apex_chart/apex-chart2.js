...
!function (t, e) {
    ...
    var u = function () {
        ...
        return a(i, [{
            key: "shadeRGBColor", value: function (t, e) {
                var i = e.split(","), a = t < 0 ? 0 : 255, s = t < 0 ? -1 * t : t, n = parseInt(i[0].slice(4)),
            ...
            key: "shadeHexColor", value: function (t, e) {
                var i = parseInt(e.slice(1), 16), a = t < 0 ? 0 : 255, s = t < 0 ? -1 * t : t, n = i >> 16,
                    r = i >> 8 & 255, o = 255 & i;
        ...
        return a(t, [{
            ...
            key: "addShadow", value: function (t, e, i) {
                var a = i.blur, s = i.top, n = i.left, r = i.color, o = i.opacity,
            ...
            key: "dropShadow", value: function (t, e) {
                var i = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : 0, a = e.top, s = e.left,
                    n = e.blur, r = e.color, o = e.opacity, l = e.noUserSpaceOnUse, h = this.w;
        ...
        return a(t, [{
            ...
            key: "animatePathsGradually", value: function (t) {
                var e = t.el, i = t.j, a = t.pathFrom, s = t.pathTo, n = t.speed, r = t.delay,
                    o = (t.strokeWidth, this.w), l = 0;
            ...
            key: "morphSVG", value: function (t, e, i, a, s, n) {
                var r = this, o = this.w;
        ...
        return a(t, [{
            ...
            key: "arc", value: function (t, e, i, a, s, n, r) {
                var o = "A";
            ...
            key: "renderPaths", value: function (t) {
                var e, i = t.j, a = t.realIndex, s = t.pathFrom, n = t.pathTo, o = t.stroke, l = t.strokeWidth,
                    h = t.strokeLinecap, c = t.fill, d = t.animationDelay, u = t.initialSpeed, p = t.dataChangeSpeed,
                    x = t.className, b = t.shouldClipToGrid, m = void 0 === b || b, v = t.bindEventsOnPaths,
                    y = void 0 === v || v, w = t.drawShadow, k = void 0 === w || w, A = this.w, S = new g(this.ctx),
                ...
                var E = A.config.stroke.dashArray, M = 0;
                ...
                if (T.attr("index", a), m && T.attr({"clip-path": "url(#gridRectMask".concat(A.globals.cuid, ")")}), "none" !== A.config.states.normal.filter.type) S.getDefaultFilter(T, a); else if (A.config.chart.dropShadow.enabled && k && (!A.config.chart.dropShadow.enabledSeries || A.config.chart.dropShadow.enabledSeries && -1 !== A.config.chart.dropShadow.enabledSeries.indexOf(a))) {
                ...
                return !L || A.globals.resized || A.globals.dataChanged ? !A.globals.resized && A.globals.dataChanged || C.showDelayedElements() : C.animatePathsGradually(r({}, X, {
                    speed: u,
                    delay: d
                })), A.globals.dataChanged && P && z && C.animatePathsGradually(r({}, X, {speed: p})), T
            }
        }, {
            ...
            key: "drawText", value: function (t) {
                var e, i = this.w, a = t.x, s = t.y, n = t.text, r = t.textAnchor, o = t.fontSize, l = t.fontFamily,
            ...
            key: "drawMarker", value: function (t, e, i) {
                ...
                if ("square" === i.shape) {
                    ...
                    null === e && (a = 0, n = 0);
                    var r = 1.2 * a + n, o = this.drawRect(r, r, r, r, n);
                    o.attr({
                        x: t - r / 2,
                        y: e - r / 2,
                        cx: t,
            ...
            key: "pathMouseEnter", value: function (t, e) {
                var i = this.w, a = new g(this.ctx), s = parseInt(t.node.getAttribute("index")),
            ...
            key: "getTextRects", value: function (t, e, i, a) {
                var s = !(arguments.length > 4 && void 0 !== arguments[4]) || arguments[4], n = this.w,
                    r = this.drawText({
                        x: -200,
                        y: -200,
                        text: t,
    ...
    var x = {
        ...
        return a(t, [{
            ...
            key: "getStringX", value: function (t) {
                var e = this.w, i = t, a = e.globals.labels.indexOf(t),
            ...
            key: "addXaxisAnnotation", value: function (t, e, i) {
                var a = this.w, s = this.invertAxis ? a.globals.minY : a.globals.minX,
                    ...
                    r = (t.x - s) / (n / a.globals.gridWidth), o = t.label.text;
            ...
            key: "addPointAnnotation", value: function (t, e, i) {
                ...
                if (!(s < 0 || s > a.globals.gridWidth)) {
                    ...
                    if (g.attr({rel: i}), e.appendChild(g.node), t.customSVG.SVG) {
                        ...
                        f.attr({transform: "translate(".concat(s + t.customSVG.offsetX, ", ").concat(n + t.customSVG.offsetY, ")")}), f.node.innerHTML = t.customSVG.SVG, e.appendChild(f.node)
                    }
                }
            }
        }, {
            ...
            key: "setOrientations", value: function (t) {
                ...
                if ("vertical" === t.label.orientation) {
                    ...
                    if (null !== s) {
                        ...
                        var r = this.graphics.rotateAroundCenter(s), o = r.x, l = r.y;
            ...
            key: "addBackgroundToAnno", value: function (t, e) {
                ...
                var a = i.globals.dom.baseEl.querySelector(".apexcharts-grid").getBoundingClientRect(),
                    s = t.getBoundingClientRect(), n = e.label.style.padding.left, r = e.label.style.padding.right,
                ...
                var h = s.left - a.left - n, c = s.top - a.top - o,
            ...
            key: "addText", value: function (t, e, i) {
                var a = t.x, s = t.y, n = t.text, r = t.textAnchor, o = t.appendTo,
            ...
            key: "addAnnotationExternal", value: function (t) {
                var e = t.params, i = t.pushToMemory, a = t.context, s = t.type, n = t.contextMethod, r = a, o = r.w,
                    l = o.globals.dom.baseEl.querySelector(".apexcharts-".concat(s, "-annotations")),
                    h = l.childNodes.length + 1, c = new b,
        ...
        return a(t, [{
            ...
            key: "formatDate", value: function (t, e) {
                var i = !(arguments.length > 2 && void 0 !== arguments[2]) || arguments[2],
                    a = !(arguments.length > 3 && void 0 !== arguments[3]) || arguments[3], s = this.w.globals.locale,
                    n = ["\0"].concat(d(s.months)), r = ["\x01"].concat(d(s.shortMonths)),
                    o = ["\x02"].concat(d(s.days)), l = ["\x03"].concat(d(s.shortDays));
            ...
            key: "getTimeUnitsfromTimestamp", value: function (t, e) {
                ...
                var a = new Date(t).getFullYear(), s = new Date(e).getFullYear(), n = new Date(t).getMonth(),
                ...
                return {
                    ...
                    tooltip: {
                        shared: !1, followCursor: !0, custom: function (t) {
                            var e = t.ctx, i = t.seriesIndex, a = t.dataPointIndex, s = t.w,
                                n = s.globals.seriesRangeStart[i][a], r = s.globals.seriesRangeEnd[i][a], o = "",
                                l = "", h = s.globals.colors[i];
                            if (void 0 === s.config.tooltip.x.formatter) if ("datetime" === s.config.xaxis.type) {
                                var c = new v(e);
                                o = c.formatDate(new Date(n), s.config.tooltip.x.format, !0, !0), l = c.formatDate(new Date(r), s.config.tooltip.x.format, !0, !0)
                            } else o = n, l = r; else o = s.config.tooltip.x.formatter(n), l = s.config.tooltip.x.formatter(r);
            ...
            key: "getPercentSeries", value: function () {
                ...
                t.globals.seriesPercent = t.globals.series.map(function (e, i) {
                    ...
                    if (Array.isArray(e)) for (var s = 0; s < e.length; s++) {
                        var n = t.globals.stackedSeriesTotals[s], r = 0;
        ...
        return a(i, [{
            key: "init", value: function () {
                var e = this.opts, i = new b, a = new y(e);
        ...
        return a(t, [{
            key: "clippedImgArea", value: function (t) {
                var e = this.w, i = e.config, a = parseInt(e.globals.gridWidth), s = parseInt(e.globals.gridHeight),
                    n = a > s ? a : s, r = t.image, o = 0, l = 0;
            ...
            key: "fillPath", value: function (t) {
                ...
                var o = this.getFillType(this.seriesIndex),
                    l = Array.isArray(n.fill.opacity) ? n.fill.opacity[this.seriesIndex] : n.fill.opacity, h = r;
            ...
            key: "handlePatternFill", value: function (t, e, i, a) {
                var s = this.w.config, n = this.opts, r = new p(this.ctx),
            ...
            key: "handleGradientFill", value: function (t, e, i, a) {
                var s, n, r = this.w.config, o = this.opts, l = new p(this.ctx), h = new u, c = r.fill.gradient.type,
        ...
        return a(t, [{
            ...
            key: "plotChartMarkers", value: function (t, e, i) {
                ...
                if (s.globals.markers.size[e] > 0 && (o = l.group({class: "apexcharts-series-markers"})).attr("clip-path", "url(#gridRectMarkerMask".concat(s.globals.cuid, ")")), r.x instanceof Array) for (var h = 0; h < r.x.length; h++) {
                    var c = i;
            ...
            key: "getMarkerConfig", value: function (t, e) {
                var i = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : null, a = this.w,
                    s = this.getMarkerStyle(e), n = a.globals.markers.size[e], r = a.config.markers;
        ...
        return a(t, [{
            key: "draw", value: function (t, e, i) {
                var a = this.w, s = new p(this.ctx), n = i.realIndex, r = i.pointsPos, o = i.zRatio, l = i.elParent,
                    h = s.group({class: "apexcharts-series-markers apexcharts-series-".concat(a.config.chart.type)});
                if (h.attr("clip-path", "url(#gridRectMarkerMask".concat(a.globals.cuid, ")")), r.x instanceof Array) for (var c = 0; c < r.x.length; c++) {
                    var d = e + 1, u = !0;
            ...
            key: "drawPoint", value: function (t, e, i, a, s, n, r) {
                var o = this.w, l = s, h = new f(this.ctx), c = new g(this.ctx), d = new C(this.ctx),
                    u = new L(this.ctx), x = new p(this.ctx), b = u.getMarkerConfig("apexcharts-marker", l),
        ...
        return a(t, [{
            key: "dataLabelsCorrection", value: function (t, e, i, a, s, n, r) {
                var o = this.w, l = !1, h = new p(this.ctx).getTextRects(i, r), c = h.width, d = h.height;
            ...
            key: "drawDataLabel", value: function (t, e, i) {
                var a = arguments.length > 4 && void 0 !== arguments[4] ? arguments[4] : "top", s = this.w,
                    n = new p(this.ctx), r = s.config.dataLabels, o = 0, l = 0, h = i, c = null;
                if (!r.enabled || t.x instanceof Array != !0) return c;
                c = n.group({class: "apexcharts-data-labels"});
                for (var d = 0; d < t.x.length; d++) if (o = t.x[d] + r.offsetX, l = t.y[d] + r.offsetY - s.globals.markers.size[e] - 5, "bottom" === a && (l = l + 2 * s.globals.markers.size[e] + 1.4 * parseInt(r.style.fontSize)), !isNaN(o)) {
                    1 === i && 0 === d && (h = 0), 1 === i && 1 === d && (h = 1);
                    var u = s.globals.series[e][h], g = "";
                    if ("bubble" === s.config.chart.type) u = s.globals.seriesZ[e][h], g = s.config.dataLabels.formatter(u, {
                        ctx: this.ctx,
                        seriesIndex: e,
                        dataPointIndex: h,
                        w: s
                    }), l = t.y[d] + s.config.dataLabels.offsetY, l = new P(this.ctx).centerTextInBubble(l, e, h).y; else void 0 !== u && (g = s.config.dataLabels.formatter(u, {
                        ctx: this.ctx,
                        seriesIndex: e,
                        dataPointIndex: h,
                        w: s
            ...
            key: "plotDataLabelsText", value: function (t) {
                var e = this.w, i = new p(this.ctx), a = t.x, s = t.y, n = t.i, r = t.j, o = t.text, l = t.textAnchor,
                    h = t.parent, c = t.dataLabelsConfig, d = t.alwaysDrawDataLabel, u = t.offsetCorrection;
        ...
        return a(t, [{
            key: "draw", value: function (t, e) {
                var i = this.w, a = new p(this.ctx), s = new w(this.ctx, i);
                ...
                for (var r = 0, o = 0; r < t.length; r++, o++) {
                    var l, h, c, d, g = void 0, f = void 0, x = void 0, b = void 0, m = [], v = [],
                        y = i.globals.comboCharts ? e[r] : r, k = a.group({
                    ...
                    for (var P = a.group({class: "apexcharts-datalabels"}), z = 0, E = i.globals.dataPoints; z < i.globals.dataPoints; z++, E--) {
            ...
            key: "getPathFillColor", value: function (t, e, i, a) {
                var s = this.w, n = new C(this.ctx), r = null, o = this.barOptions.distributed ? i : e;
            ...
            key: "renderSeries", value: function (t) {
                var e = t.realIndex, i = t.pathFill, a = t.lineFill, s = t.j, n = t.i, r = t.pathFrom, o = t.pathTo,
                    l = t.strokeWidth, h = t.elSeries, c = t.x, d = t.y, u = t.series, f = t.barHeight, x = t.barWidth,
                    b = t.elDataLabelsWrap, m = t.visibleSeries, v = t.type, y = this.w, w = new p(this.ctx);
            ...
            key: "initVariables", value: function (t) {
                ...
                for (var i = 0; i < t.length; i++) if (t[i].length > 0 && (this.seriesLen = this.seriesLen + 1, this.totalItems += t[i].length), e.globals.isXNumeric) for (var a = 0; a < t[i].length; a++) e.globals.seriesX[i][a] > e.globals.minX && e.globals.seriesX[i][a] < e.globals.maxX && this.visibleItems++; else this.visibleItems = e.globals.dataPoints;
            ...
            key: "drawBarPaths", value: function (t) {
                var e = t.indexes, i = t.barHeight, a = t.strokeWidth, s = t.pathTo, n = t.pathFrom, r = t.zeroW,
                    o = t.x, l = t.y, h = t.yDivision, c = t.elSeries, d = this.w, u = new p(this.ctx), g = e.i,
                    f = e.j, x = e.realIndex, b = e.bc;
            ...
            key: "drawColumnPaths", value: function (t) {
                var e = t.indexes, i = t.x, a = t.y, s = t.xDivision, n = t.pathTo, r = t.pathFrom, o = t.barWidth,
                    l = t.zeroH, h = t.strokeWidth, c = t.elSeries, d = this.w, u = new p(this.ctx), g = e.i, f = e.j,
            ...
            key: "calculateDataLabelsPos", value: function (t) {
                var e = t.x, i = t.y, a = t.i, s = t.j, n = t.realIndex, r = t.series, o = t.barHeight, l = t.barWidth,
                    h = t.visibleSeries, c = t.renderedPath, d = this.w, u = new p(this.ctx),
                    g = Array.isArray(this.strokeWidth) ? this.strokeWidth[n] : this.strokeWidth,
                    f = e + parseFloat(l * h), x = i + parseFloat(o * h);
            ...
            key: "calculateColumnsDataLabelsPosition", value: function (t) {
                var e, i = this.w, a = t.i, s = t.j, n = t.y, r = t.bcx, o = t.barWidth, l = t.barHeight,
            ...
            key: "calculateBarsDataLabelsPosition", value: function (t) {
                var e = this.w, i = t.x, a = t.i, s = t.j, n = t.bcy, r = t.barHeight, o = t.barWidth, l = t.textRects,
            ...
            key: "drawCalculatedDataLabels", value: function (t) {
                var e = t.x, i = t.y, a = t.val, s = t.i, n = t.j, o = t.textRects, l = t.barHeight, h = t.barWidth,
                    c = t.dataLabelsConfig, d = this.w, u = "rotate(0)";
                "vertical" === d.config.plotOptions.bar.dataLabels.orientation && (u = "rotate(-90, ".concat(e, ", ").concat(i, ")"));
                var g = new z(this.ctx), f = new p(this.ctx), x = c.formatter, b = null,
                ...
                if (c.enabled && !m) {
                    ...
                    var y = this.series[s][n] <= 0, w = d.config.plotOptions.bar.dataLabels.position;
            ...
            key: "barEndingShape", value: function (t, e, i, a, s) {
        ...
        return o(i, E), a(i, [{
            key: "draw", value: function (t, e) {
                ...
                for (var n = this.graphics.group({class: "apexcharts-bar-series apexcharts-plot-series"}), r = 0, o = 0, l = 0, h = 0; l < t.length; l++, h++) {
                    var c = void 0, d = void 0, g = void 0, f = void 0, x = void 0, b = void 0, m = [], v = [],
                    ...
                    var k = this.graphics.group({
                            ...
                            rel: l + 1,
                            "data:realIndex": y
                        }), A = this.graphics.group({class: "apexcharts-datalabels"}), S = 0, L = 0, P = 0,
        ...
        return o(i, E), a(i, [{
            key: "draw", value: function (t, e) {
                var i = this.w, a = new p(this.ctx), s = new C(this.ctx);
                ...
                for (var r = a.group({class: "apexcharts-candlestick-series apexcharts-plot-series"}), o = 0, l = 0; o < t.length; o++, l++) {
                    var h, c, d = void 0, g = void 0, f = void 0, x = void 0, b = [], m = [],
                        v = i.globals.comboCharts ? e[o] : o, y = a.group({
                            class: "apexcharts-series",
            ...
            key: "drawCandleStickPaths", value: function (t) {
                var e = t.indexes, i = t.x, a = (t.y, t.xDivision), s = t.pathTo, n = t.pathFrom, r = t.barWidth,
                    o = t.zeroH, l = t.strokeWidth, h = this.w, c = new p(this.ctx), d = e.i, u = e.j, g = !0,
        ...
        return a(t, [{
            key: "drawXCrosshairs", value: function () {
                var t = this.w, e = new p(this.ctx), i = new g(this.ctx), a = t.config.xaxis.crosshairs.fill.gradient,
                    s = t.config.xaxis.crosshairs.dropShadow, n = t.config.xaxis.crosshairs.fill.type, r = a.colorFrom,
        ...
        return a(t, [{
            key: "draw", value: function (t) {
                ...
                var s = e.globals.gridWidth / e.globals.dataPoints, n = e.globals.gridHeight / e.globals.series.length,
                    r = 0, o = !1;
                ...
                for (var h = o ? 0 : l.length - 1; o ? h < l.length : h >= 0; o ? h++ : h--) {
                    ...
                    for (var f = 0, x = 0; x < l[h].length; x++) {
                        ...
                        var k = this.rectRadius, A = i.drawRect(f, r, s, n, k);
                        if (A.attr({
                            cx: f,
                            cy: r
            ...
            key: "determineHeatColor", value: function (t, e) {
                var i = this.w, a = i.globals.series[t][e], s = i.config.plotOptions.heatmap,
                    n = s.colorScale.inverse ? e : t, r = i.globals.colors[n],
                ...
                var h = Math.abs(l) + Math.abs(o), c = 100 * a / (0 === h ? h - 1e-6 : h);
            ...
            key: "calculateHeatmapDataLabels", value: function (t) {
                var e = t.x, i = t.y, a = t.i, s = t.j, n = (t.series, t.rectHeight), r = t.rectWidth, o = this.w,
                    l = o.config.dataLabels, h = new p(this.ctx), c = new z(this.ctx), d = l.formatter, u = null;
                if (l.enabled) {
                    u = h.group({class: "apexcharts-data-labels"});
                    var g = l.offsetX, f = l.offsetY, x = e + r / 2 + g,
        ...
        return a(t, [{
            ...
            key: "drawArcs", value: function (t, e) {
                var i = this.w, a = new g(this.ctx), s = new p(this.ctx), n = new C(this.ctx),
                    r = s.group({class: "apexcharts-slices"}), o = 0, l = 0, h = 0, c = 0;
                ...
                for (var d = 0; d < t.length; d++) {
                    ...
                    var x = h - o, b = n.fillPath({seriesNumber: d, size: i.globals.radialSize, value: e[d]}),
                    ...
                    if (!this.initialAnim || i.globals.resized || i.globals.dataChanged ? this.animBeginArr.push(0) : (k = (h - o) / this.fullAngle * i.config.chart.animations.speed, this.animDur = k + this.animDur, this.animBeginArr.push(this.animDur)), this.dynamicAnim && i.globals.dataChanged ? this.animatePaths(v, {
                        ...
                        if (0 !== x && i.config.plotOptions.pie.dataLabels.minAngleToShowLabel < t[d]) {
                            ...
                            var z = i.globals.dataLabels.style.colors[d], E = s.drawText({
                                x: A,
                                y: S,
                                text: L,
                                textAnchor: "middle",
            ...
            key: "animatePaths", value: function (t, e) {
                var i = this.w, a = e.endAngle - e.startAngle, s = a, n = e.startAngle, r = e.startAngle;
            ...
            key: "animateArc", value: function (t, e, i, a, s, n) {
                ...
                l.globals.dataChanged && n.shouldSetPrevPaths && (r = o.getPiePath({
                    ...
                    "pie" !== l.config.chart.type && "donut" !== l.config.chart.type || this.animate(300).attr({"stroke-width": l.config.stroke.width}), n.i === l.config.series.length - 1 && h.animationCompleted(t)
                }).during(function (l) {
            ...
            key: "pieClicked", value: function (t) {
                var e, i = this.w, a = this.w.globals.radialSize + 4,
                ...
                if ("true" !== s.attr("data:pieClicked")) {
                    ...
                    var o = parseInt(s.attr("data:startAngle")), l = parseInt(s.attr("data:angle"));
                    e = this.getPiePath({
                        me: this,
                        startAngle: o,
                        angle: l,
            ...
            key: "getPiePath", value: function (t) {
                var e = t.me, i = t.startAngle, a = t.angle, s = t.size, n = this.w, r = i,
                    o = Math.PI * (r - 90) / 180, l = a + i;
                Math.ceil(l) >= 360 && (l = 359.99);
                var h = Math.PI * (l - 90) / 180, c = e.centerX + s * Math.cos(o), d = e.centerY + s * Math.sin(o),
                    g = e.centerX + s * Math.cos(h), f = e.centerY + s * Math.sin(h),
                    p = u.polarToCartesian(e.centerX, e.centerY, e.donutSize, l),
                    x = u.polarToCartesian(e.centerX, e.centerY, e.donutSize, r), b = a > 180 ? 1 : 0;
            ...
            key: "revertDataLabelsInner", value: function (e, i, a) {
                var s = this, n = this.w, r = n.globals.dom.baseEl.querySelector(".apexcharts-datalabels-group");
        ...
        function t(i) {
            ...
            })[0], n = this.graphics.getTextRects(s, a.config.dataLabels.style.fontSize);
        ...
        return a(t, [{
            key: "draw", value: function (t) {
                var e = this, i = this.w, a = new C(this.ctx), s = [];
                t.length && (this.dataPointsLen = t[i.globals.maxValsInArrayIndex].length), this.disAngle = 2 * Math.PI / this.dataPointsLen;
                var n = i.globals.gridWidth / 2, o = i.globals.gridHeight / 2, l = this.graphics.group({
                ...
                if (this.yaxisLabels = this.graphics.group({class: "apexcharts-yaxis"}), t.forEach(function (t, n) {
                    ...
                    for (var p = 0; p < l.linePathsTo.length; p++) {
                        ...
                        o.add(x);
                        var b = a.fillPath({seriesNumber: n}), m = e.graphics.renderPaths(r({}, d, {
                        ...
                        if (i.config.chart.dropShadow.enabled) {
                            var v = new g(e.ctx), y = i.config.chart.dropShadow;
            ...
            key: "drawYAxisText", value: function (t, e, i, a) {
                var s = this.w, n = s.config.yaxis[0], r = s.globals.yLabelFormatters[0];
            ...
            key: "drawLabels", value: function () {
                var t = this, e = this.w, i = "middle", a = e.config.dataLabels,
                    s = this.graphics.group({class: "apexcharts-datalabels"}), n = this.getPolygonPos(this.size), r = 0,
                    o = 0;
                return e.globals.labels.forEach(function (l, h) {
                    var c = a.formatter, d = new z(t.ctx);
                    if (n[h]) {
        ...
        return o(i, Y), a(i, [{
            key: "draw", value: function (t) {
                ...
                if (e.globals.noData) return a;
                var s = i.group(), n = this.defaultSize / 2, r = e.globals.gridWidth / 2,
                ...
                var c = this.drawArcs({size: o, centerX: r, centerY: n, colorArr: l, series: t}), d = 360;
            ...
            key: "drawTracks", value: function (t) {
                var e = this.w, i = new p(this.ctx), a = i.group({class: "apexcharts-tracks"}), s = new g(this.ctx),
                    n = new C(this.ctx), r = this.getStrokeWidth(t);
                t.size = t.size - r / 2;
            ...
            key: "drawArcs", value: function (t) {
                var e = this.w, i = new p(this.ctx), a = new C(this.ctx), s = new g(this.ctx), n = i.group(),
                ...
                for (var m = b ? t.series.length - 1 : 0; b ? m >= 0 : m < t.series.length; b ? m-- : m++) {
                    ...
                    var y = a.fillPath({seriesNumber: m, size: t.size, value: t.series[m]}), w = this.startAngle,
                        ...
                        L = Math.round(A * S) + this.startAngle, P = void 0;
            ...
            key: "drawHollowImage", value: function (t, e, i, a) {
                var s = this.w, n = new C(this.ctx), r = u.randomId(), o = s.config.plotOptions.radialBar.hollow.image;
                if (s.config.plotOptions.radialBar.hollow.imageClipped) n.clippedImgArea({
                    width: i,
                    height: i,
                    image: o,
                    patternID: "pattern".concat(s.globals.cuid).concat(r)
                }), a = "url(#pattern".concat(s.globals.cuid).concat(r, ")"); else {
        ...
        return o(i, E), a(i, [{
            key: "draw", value: function (t, e) {
                ...
                for (var n = a.group({class: "apexcharts-rangebar-series apexcharts-plot-series"}), r = 0, o = 0; r < t.length; r++, o++) {
                    var l, h, c, d, g = void 0, f = void 0, x = void 0, b = void 0,
                        m = i.globals.comboCharts ? e[r] : r, v = a.group({
                            class: "apexcharts-series",
                    ...
                    for (var S = a.group({class: "apexcharts-datalabels"}), L = 0, P = i.globals.dataPoints; L < i.globals.dataPoints; L++, P--) {
                        ...
                        var E = s.fillPath({seriesNumber: m}), M = i.globals.stroke.colors[m];
                        v = this.renderSeries({
                            realIndex: m,
                            pathFill: E,
                            lineFill: M,
            ...
            key: "drawRangeColumnPaths", value: function (t) {
                var e = t.indexes, i = t.x, a = (t.y, t.strokeWidth), s = t.xDivision, n = t.pathTo, r = t.pathFrom,
                    o = t.barWidth, l = t.zeroH, h = this.w, c = new p(this.ctx), d = e.i, u = e.j,
                    g = this.yRatio[this.yaxisIndex], f = e.realIndex, x = this.getRangeValue(f, u),
            ...
            key: "drawRangeBarPaths", value: function (t) {
                var e = t.indexes, i = (t.x, t.y), a = t.yDivision, s = t.pathTo, n = t.pathFrom, r = t.barHeight,
                    o = t.zeroW, l = this.w, h = new p(this.ctx), c = e.i, d = e.j, u = e.realIndex, g = o, f = o;
        ...
        return a(t, [{
            key: "getLabel", value: function (t, e, i, a) {
                var s, n = arguments.length > 4 && void 0 !== arguments[4] ? arguments[4] : [], r = this.w,
                    o = void 0 === t[a] ? "" : t[a], l = r.globals.xLabelFormatter, h = r.config.xaxis.labels.formatter,
                    c = !1, d = o;
            ...
            key: "drawYAxisTicks", value: function (t, e, i, a, s, n, r) {
        ...
        return a(t, [{
            key: "drawYaxis", value: function (t) {
                var e = this.w, i = new p(this.ctx), a = e.config.yaxis[t].labels.style.fontSize,
                    s = e.config.yaxis[t].labels.style.fontFamily, n = i.group({
            ...
            key: "yAxisTitleRotate", value: function (t, e) {
                var i = this.w, a = new p(this.ctx), s = {width: 0, height: 0}, n = {width: 0, height: 0},
        ...
        return a(t, [{
            ...
            key: "titleSubtitleOffset", value: function () {
                ...
                var a = this.getTitleSubtitleCoords("title"), s = this.getTitleSubtitleCoords("subtitle");
                e.gridHeight = e.gridHeight - a.height - s.height - i, e.translateY = e.translateY + a.height + s.height + i
            }
        }, {
            key: "getTotalYAxisWidth", value: function () {
                var t = this.w, e = 0, i = 10, a = function (e) {
            ...
            key: "getxAxisLabelsCoords", value: function () {
                ...
                if (e.globals.timelineLabels.length > 0) {
                    ...
                    var l = new p(this.ctx), h = l.getTextRects(r, e.config.xaxis.labels.style.fontSize);
                    (t = {
                        width: h.width,
                        height: h.height
                ...
                return e.config.yaxis.map(function (s, n) {
                    if (s.show && s.labels.show && e.globals.yAxisScale[n].result.length) {
                        ...
                        if (void 0 !== o && 0 !== o.length || (o = e.globals.yAxisScale[n].niceMax), e.globals.isBarHorizontal) a = 0, o = r(o = e.globals.labels.slice().reduce(function (t, e) {
                            return t.length > e.length ? t : e
                        }, 0), {seriesIndex: n, dataPointIndex: -1, w: e});
        ...
        return a(t, [{
            ...
            key: "isSeriesHidden", value: function (t) {
                var e = this.getSeriesByName(t), i = parseInt(e.getAttribute("data:realIndex"));
            ...
            key: "toggleSeriesOnHover", value: function (t, e) {
                ...
                if ("mousemove" === t.type) {
                    var s = parseInt(e.getAttribute("rel")) - 1, n = null;
            ...
            key: "getPreviousPaths", value: function () {
                ...
                function e(e, i, a) {
                    ...
                    }, r = 0; r < s.length; r++) if (s[r].hasAttribute("pathTo")) {
            ...
            key: "handleNoData", value: function () {
                var t = this.w, e = t.config.noData, i = new p(this.ctx), a = t.globals.svgWidth / 2,
                    s = t.globals.svgHeight / 2, n = "middle";
        ...
        return a(t, [{
            ...
            key: "drawLegends", value: function () {
                ...
                for (var n = t.globals.legendFormatter, r = t.config.legend.inverseOrder, o = r ? i.length - 1 : 0; r ? o >= 0 : o <= i.length - 1; r ? o-- : o++) {
                    var l = n(i[o], {seriesIndex: o, w: t}), h = !1, c = !1;
                    ...
                    var f = t.config.legend.markers.offsetX, x = t.config.legend.markers.offsetY,
                        ...
                        k = t.config.legend.markers.radius, A = g.style;
            ...
            key: "setLegendWrapXY", value: function (t, e) {
                var i = this.w, a = i.globals.dom.baseEl.querySelector(".apexcharts-legend"),
                    s = a.getBoundingClientRect(), n = 0, r = 0;
                if ("bottom" === i.config.legend.position) r += i.globals.svgHeight - s.height / 2; else if ("top" === i.config.legend.position) {
                    var o = new W(this.ctx), l = o.getTitleSubtitleCoords("title").height,
            ...
            key: "legendAlignHorizontal", value: function () {
                ...
                var e = this.getLegendBBox(), i = new W(this.ctx), a = i.getTitleSubtitleCoords("title"),
                    s = i.getTitleSubtitleCoords("subtitle"), n = 0;
            ...
            key: "onLegendHovered", value: function (t) {
                ...
                if ("heatmap" !== e.config.chart.type) !t.target.classList.contains("inactive-legend") && i && new B(this.ctx).toggleSeriesOnHover(t, t.target); else if (i) {
            ...
            key: "toggleDataSeries", value: function (t, e) {
                ...
                if (i.globals.axisCharts || "radialBar" === i.config.chart.type) {
                    ...
                    if ("pie" === c || "donut" === c) {
                        var d = i.config.plotOptions.pie.donut.labels, u = new p(this.ctx), g = new Y(this.ctx);
        ...
        return a(t, [{
            key: "draw", value: function (t, e, i) {
                var a = this.w, s = new p(this.ctx), n = new C(this.ctx),
                ...
                for (var d = this.xyRatios.zRatio, g = this.xyRatios.xRatio, f = this.xyRatios.baseLineY, x = [], b = [], m = 0, v = 0; v < t.length; v++) {
                    ...
                    var k = a.globals.gridWidth / a.globals.dataPoints, A = a.globals.comboCharts ? i[v] : v;
                    ...
                    if ("area" === o) for (var ot = n.fillPath({seriesNumber: A}), lt = 0; lt < O.length; lt++) {
            ...
            key: "createPaths", value: function (t) {
                var e = t.series, i = t.i, a = t.j, s = t.x, n = t.y, r = t.pX, o = t.pY, l = t.xDivision,
                    h = t.areaBottomY, c = t.linePath, d = t.areaPath, u = t.linePaths, g = t.areaPaths,
                    f = t.seriesIndex, x = this.w, b = new p(this.ctx), m = x.config.stroke.curve;
            ...
            key: "calculatePoints", value: function (t) {
                var e = t.series, i = t.realIndex, a = t.x, s = t.y, n = t.i, r = t.j, o = t.prevY,
                    l = t.categoryAxisCorrection, h = t.xRatio, c = this.w, d = [], g = [];
                if (0 === r) {
            ...
            key: "determineFirstPrevY", value: function (t) {
                var e = t.i, i = t.series, a = t.yRatio, s = t.zeroY, n = t.prevY, r = t.prevSeriesY,
                    o = t.lineYPosition, l = this.w;
                if (void 0 !== i[e][0]) n = l.config.chart.stacked ? (o = e > 0 ? r[e - 1][0] : s) - i[e][0] / a + 2 * (this.isReversed ? i[e][0] / a : 0) : s - i[e][0] / a + 2 * (this.isReversed ? i[e][0] / a : 0); else if (l.config.chart.stacked && e > 0 && void 0 === i[e][0]) for (var h = e - 1; h >= 0; h--) if (null !== i[h][0] && void 0 !== i[h][0]) {
                    n = o = r[h][0];
                    break
                }
        ...
        return a(t, [{
            ...
            key: "drawXaxisInversed", value: function (t) {
                var e, i, a = this.w, s = new p(this.ctx),
                    ...
                    r = s.group({class: "apexcharts-yaxis apexcharts-xaxis-inversed", rel: t}), o = s.group({
            ...
            key: "getXAxisTicksPositions", value: function () {
                ...
                if (t.globals.timelineLabels.length > 0) for (var s = 0; s < i; s++) a = this.xaxisLabels[s].position, e.push(a); else for (var n = i, r = 0; r < n; r++) {
                    var o = n;
            ...
            key: "xAxisLabelCorrections", value: function () {
                ...
                if (t.globals.rotateXLabels || t.config.xaxis.labels.rotateAlways) for (var r = 0; r < a.length; r++) {
                ...
                } else for (var h = t.globals.gridWidth / t.globals.labels.length, c = 0; c < a.length; c++) {
        ...
        return a(t, [{
            key: "niceScale", value: function (t, e, i) {
                var a = arguments.length > 3 && void 0 !== arguments[3] ? arguments[3] : 0,
                    s = arguments.length > 4 && void 0 !== arguments[4] ? arguments[4] : 10, n = this.w,
                ...
                var h = s + 1;
                h < 2 ? h = 2 : h > 2 && (h -= 2);
                var c = l / h, d = Math.floor(u.log10(c)), g = Math.pow(10, d), f = Math.round(c / g);
                f < 1 && (f = 1);
                var p = f * g, x = p * Math.floor(t / p), b = p * Math.ceil(e / p), m = x;
                if (r && l > 2) {
                    for (; o.push(m), !((m += p) > b);) ;
            ...
            key: "linearScale", value: function (t, e) {
                var i = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : 10, a = Math.abs(e - t) / i;
            ...
            key: "logarithmicScale", value: function (t, e, i, a) {
                ...
                var h = o.map(function (t, a) {
                    t <= 0 && (t = .01);
                    var r = (n - s) / (i - e), o = Math.pow(10, s + r * (t - s));
            ...
            key: "setYScaleForIndex", value: function (t, e, i) {
                ...
                if (void 0 === a.yAxisScale[t] && (a.yAxisScale[t] = []), n.logarithmic) a.allSeriesCollapsed = !1, a.yAxisScale[t] = this.logarithmicScale(t, e, i, n.tickAmount ? n.tickAmount : Math.floor(Math.log10(i))); else if (i !== -Number.MAX_VALUE && u.isNumber(i)) if (a.allSeriesCollapsed = !1, void 0 === n.min && void 0 === n.max || n.forceNiceScale) {
                    var r = Math.abs(i - e);
                    a.yAxisScale[t] = this.niceScale(e, i, r, t, n.tickAmount ? n.tickAmount : r < 5 && r > 1 ? r + 1 : 5)
                } else a.yAxisScale[t] = this.linearScale(e, i, n.tickAmount); else a.yAxisScale[t] = this.linearScale(0, 5, 5)
            }
        }, {
            ...
            key: "sameScaleInMultipleAxes", value: function (t, e, i) {
                var a = this, s = this.w.config, n = this.w.globals, r = [];
        ...
        return a(t, [{
            ...
            key: "getMinYMaxY", value: function (t) {
                var e = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : Number.MAX_VALUE,
                    ...
                    a = arguments.length > 3 && void 0 !== arguments[3] ? arguments[3] : null, s = this.w.globals,
                    n = -Number.MAX_VALUE, r = Number.MIN_VALUE;
                null === a && (a = t + 1);
                var o = s.series, l = o, h = o;
            ...
            key: "setYRange", value: function () {
                ...
                if (t.minY = n.minY, t.maxY = n.maxY, i = n.lowestY, e.chart.stacked) {
                    var r = [], o = [];
                    if (t.series.length) for (var l = 0; l < t.series[t.maxValsInArrayIndex].length; l++) for (var h = 0, c = 0, d = 0; d < t.series.length; d++) null !== t.series[d][l] && u.isNumber(t.series[d][l]) && (t.series[d][l] > 0 ? h = h + parseFloat(t.series[d][l]) + 1e-4 : c += parseFloat(t.series[d][l])), d === t.series.length - 1 && (r.push(h), o.push(c));
            ...
            key: "setXRange", value: function () {
                ...
                if (e.isXNumeric) for (var s = 0; s < e.series.length; s++) if (e.labels[s]) for (var n = 0; n < e.labels[s].length; n++) null !== e.labels[s][n] && u.isNumber(e.labels[s][n]) && (e.maxX = Math.max(e.maxX, e.labels[s][n]), e.initialmaxX = Math.max(e.maxX, e.labels[s][n]), e.minX = Math.min(e.minX, e.labels[s][n]), e.initialminX = Math.min(e.minX, e.labels[s][n]));
                if (e.noLabelsProvided && 0 === i.xaxis.categories.length && (e.maxX = e.labels[e.labels.length - 1], e.initialmaxX = e.labels[e.labels.length - 1], e.minX = 1, e.initialminX = 1), (e.comboChartsHasBars || "candlestick" === i.chart.type || "bar" === i.chart.type && e.isXNumeric) && ("category" !== i.xaxis.type || e.isXNumeric)) {
                    var r = e.svgWidth / e.dataPoints * (Math.abs(e.maxX - e.minX) / e.svgWidth), o = e.minX - r / 2;
            ...
            key: "setZRange", value: function () {
                var t = this.w.globals;
                if (t.isDataXYZ) for (var e = 0; e < t.series.length; e++) if (void 0 !== t.seriesZ[e]) for (var i = 0; i < t.seriesZ[e].length; i++) null !== t.seriesZ[e][i] && u.isNumber(t.seriesZ[e][i]) && (t.maxZ = Math.max(t.maxZ, t.seriesZ[e][i]), t.minZ = Math.min(t.minZ, t.seriesZ[e][i]))
            }
        }]), t
    }(), q = function () {
        function t(i) {
        ...
        return a(t, [{
            key: "calculateTimeScaleTicks", value: function (t, e) {
                ...
                var s = new v(this.ctx), n = (e - t) / 864e5;
                ...
                var o = s.getTimeUnitsfromTimestamp(t, e), l = a.globals.gridWidth / n, h = l / 24, c = h / 60,
                    d = Math.floor(24 * n), u = Math.floor(24 * n * 60), g = Math.floor(n), f = Math.floor(n / 30),
                    p = Math.floor(n / 365), x = {
                ...
                var m = this.timeScaleArray.map(function (t) {
                    ...
                    return "month" === t.unit ? r({}, e, {
                        day: 1,
                        value: t.value + 1
                    }) : "day" === t.unit || "hour" === t.unit ? r({}, e, {value: t.value}) : "minute" === t.unit ? r({}, e, {
                        value: t.value,
                        minute: t.value
                    }) : t
                });
            ...
            key: "generateYearScale", value: function (t) {
                var e = t.firstVal, i = t.currentMonth, a = t.currentYear, s = t.daysWidthOnXAxis, n = t.numberOfYears,
                    r = e.minYear, o = 0, l = new v(this.ctx);
            ...
            key: "generateMonthScale", value: function (t) {
                var e = t.firstVal, i = t.currentMonthDate, a = t.currentMonth, s = t.currentYear,
                    n = t.daysWidthOnXAxis, r = t.numberOfMonths, o = a, l = 0, h = new v(this.ctx), c = "month", d = 0;
                if (e.minDate > 1) {
                    l = (h.determineDaysOfMonths(a + 1, e.minYear) - i + 1) * n, o = u.monthMod(a + 1);
                    var g = s + d, f = u.monthMod(o), p = o;
            ...
            key: "generateDayScale", value: function (t) {
                var e = t.firstVal, i = t.currentMonth, a = t.currentYear, s = t.hoursWidthOnXAxis, n = t.numberOfDays,
                    r = new v(this.ctx), o = "day", l = (24 - e.minHour) * s, h = e.minDate + 1, c = h,
                    d = function (t, e, i) {
            ...
            key: "generateHourScale", value: function (t) {
                var e = t.firstVal, i = t.currentDate, a = t.currentMonth, s = t.currentYear, n = t.minutesWidthOnXAxis,
                    r = t.numberOfHours, o = new v(this.ctx), l = "hour", h = function (t, e) {
                        return t > o.determineDaysOfMonths(e + 1, s) && (x = 1, e += 1), {month: e, date: x}
                    }, c = function (t, e) {
                        return t > o.determineDaysOfMonths(e + 1, s) ? e += 1 : e
                    }, d = 60 - e.minMinute, g = d * n, f = e.minHour + 1, p = f + 1;
            ...
            key: "generateMinuteScale", value: function (t) {
                var e = t.firstVal, i = t.currentMinute, a = t.currentHour, s = t.currentDate, n = t.currentMonth,
                    r = t.currentYear, o = t.minutesWidthOnXAxis, l = t.numberOfMinutes, h = o - (i - e.minMinute),
                    c = e.minMinute + 1, d = c + 1, g = s, f = n, p = r, x = a;
                this.timeScaleArray.push({
                    position: h,
                    value: c,
                    unit: "minute",
            ...
            key: "formatDates", value: function (t) {
                var e = this, i = this.w;
                return t.map(function (t) {
                    var a = t.value.toString(), s = new v(e.ctx), n = e.createRawDateString(t, a),
            ...
            key: "removeOverlappingTS", value: function (t) {
                var e = this, i = new p(this.ctx), a = 0, s = t.map(function (s, n) {
                    if (n > 0 && e.w.config.xaxis.labels.hideOverlappingLabels) {
                        var r = i.getTextRects(t[a].value).width, o = t[a].position;
        ...
        return a(t, [{
            ...
            key: "plotChartType", value: function (t, e) {
                var i = this.w, a = i.config, s = i.globals, n = {series: [], i: []}, r = {series: [], i: []},
                ...
                var d = new G(this.ctx, e), u = new T(this.ctx, e), g = new Y(this.ctx), f = new R(this.ctx),
                    p = new D(this.ctx, e), x = new F(this.ctx), b = [];
                if (s.comboCharts) {
                    if (r.series.length > 0 && b.push(d.draw(r.series, "area", r.i)), h.series.length > 0) if (i.config.chart.stacked) {
                    ...
                    case"area":
                        ...
                        break;
                    case"bar":
                        if (a.chart.stacked) b = new M(this.ctx, e).draw(s.series); else b = new E(this.ctx, e).draw(s.series);
                        break;
                    case"candlestick":
            ...
            key: "setSVGDimensions", value: function () {
                ...
                var i = u.getDimensions(this.el), a = e.chart.width.toString().split(/[0-9]+/g).pop();
                if ("%" === a ? u.isNumber(i[0]) && (0 === i[0].width && (i = u.getDimensions(this.el.parentNode)), t.svgWidth = i[0] * parseInt(e.chart.width) / 100) : "px" !== a && "" !== a || (t.svgWidth = parseInt(e.chart.width)), "auto" !== t.svgHeight && "" !== t.svgHeight) if ("%" === e.chart.height.toString().split(/[0-9]+/g).pop()) {
            ...
            key: "resizeNonAxisCharts", value: function () {
                ...
                if (a) {
                    ...
                    if (n = r.bottom, s) {
                        var o = u.getBoundingClientRect(s), l = Math.max(r.bottom, o.bottom) - r.top + o.height;
            ...
            key: "isFormatXY", value: function () {
                var t = this.w.config.series.slice(), e = new B(this.ctx);
            ...
            key: "handleFormat2DArray", value: function (t, e) {
                for (var i = this.w.config, a = this.w.globals, s = 0; s < t[e].data.length; s++) if (void 0 !== t[e].data[s][1] && (Array.isArray(t[e].data[s][1]) && 4 === t[e].data[s][1].length ? this.twoDSeries.push(u.parseNumber(t[e].data[s][1][3])) : 5 === t[e].data[s].length ? this.twoDSeries.push(u.parseNumber(t[e].data[s][4])) : this.twoDSeries.push(u.parseNumber(t[e].data[s][1])), a.dataFormatXNumeric = !0), "datetime" === i.xaxis.type) {
            ...
            key: "handleFormatXY", value: function (t, e) {
                var i = this.w.config, a = this.w.globals, s = new v(this.ctx), n = e;
                ...
                for (var o = 0; o < t[n].data.length; o++) {
                    var l = "string" == typeof t[n].data[o].x, h = !!s.isValidDate(t[n].data[o].x.toString());
            ...
            key: "handleCandleStickDataFormat", value: function (t, e, i) {
                ...
                if ("array" === t) {
                    ...
                    if (5 === e[i].data[0].length) for (var l = 0; l < e[i].data.length; l++) a.push(e[i].data[l][1]), s.push(e[i].data[l][2]), n.push(e[i].data[l][3]), r.push(e[i].data[l][4]); else for (var h = 0; h < e[i].data.length; h++) a.push(e[i].data[h][1][0]), s.push(e[i].data[h][1][1]), n.push(e[i].data[h][1][2]), r.push(e[i].data[h][1][3])
                } else if ("xy" === t) {
            ...
            key: "parseDataAxisCharts", value: function (t) {
                for (var e = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : this.ctx, i = this.w.config, a = this.w.globals, s = new v(e), n = 0; n < t.length; n++) {
                    ...
                    if ("rangeBar" !== i.chart.type && "rangeArea" !== i.chart.type && "rangeBar" !== t[n].type && "rangeArea" !== t[n].type || (a.isRangeData = !0, this.handleRangeData(t, n)), this.isMultiFormat()) this.isFormat2DArray() ? this.handleFormat2DArray(t, n) : this.isFormatXY() && this.handleFormatXY(t, n), "candlestick" !== i.chart.type && "candlestick" !== t[n].type || this.handleCandleStickData(t, n), a.series.push(this.twoDSeries), a.labels.push(this.twoDSeriesX), a.seriesX.push(this.twoDSeriesX), this.fallbackToCategory || (a.isXNumeric = !0); else {
            ...
            key: "setupBrushHandler", value: function () {
                ...
                if (e.config.chart.brush.enabled && "function" != typeof e.config.chart.events.selection) {
                    ...
                    i.forEach(function (e) {
                        ...
                        i.forEach(function (t) {
                            var i = ApexCharts.getChartByID(t), s = u.clone(e.config.yaxis);
    ...
    var nt, rt, ot = function () {
        ...
        return a(t, [{
            ...
            key: "drawGrid", value: function () {
                var t = this.w, e = new _(this.ctx), i = new H(this.ctx), a = this.w.globals, s = null;
                if (a.axisCharts) {
                    if (t.config.grid.show) s = this.renderGrid(), a.dom.elGraphical.add(s.el), this.drawGridArea(s.el); else {
            ...
            key: "renderGrid", value: function () {
                var t = this.w, e = new p(this.ctx), i = t.config.grid.strokeDashArray,
                    a = e.group({class: "apexcharts-grid"}), s = e.group({class: "apexcharts-gridlines-horizontal"}),
                ...
                if (t.globals.isBarHorizontal) {
                    ...
                    if (t.config.grid.yaxis.lines.show) for (var f = 0, x = 0, b = t.globals.gridWidth, m = 0; m < t.globals.dataPoints + 1; m++) {
                        ...
                        s.add(v), v.node.classList.add("apexcharts-gridline"), this.animY && this.animateLine(v, {
                            y1: f + 20,
                            y2: x + 20
                        }, {y1: f, y2: x}), x = f += t.globals.gridHeight / t.globals.dataPoints
                    }
                } else {
                    ...
                    if (t.config.grid.yaxis.lines.show) for (var M = 0, T = 0, I = t.globals.gridWidth, X = 0; X < o + 1; X++) {
                        ...
                        s.add(Y), Y.node.classList.add("apexcharts-gridline"), this.animY && this.animateLine(Y, {
                            y1: M + 20,
                            y2: T + 20
                        }, {y1: M, y2: T}), T = M += t.globals.gridHeight / o
                    }
                }
            ...
            key: "drawGridBands", value: function (t, e, i) {
                ...
                if (void 0 !== a.config.grid.row.colors && a.config.grid.row.colors.length > 0) for (var n = 0, r = a.globals.gridHeight / i, o = a.globals.gridWidth, l = 0, h = 0; l < i; l++, h++) {
                    h >= a.config.grid.row.colors.length && (h = 0);
                    var c = a.config.grid.row.colors[h], d = s.drawRect(0, n, o, r, 0, c, a.config.grid.row.opacity);
                    t.add(d), d.node.classList.add("apexcharts-gridRow"), n += a.globals.gridHeight / i
                }
                if (void 0 !== a.config.grid.column.colors && a.config.grid.column.colors.length > 0) for (var u = a.globals.padHorizontal, g = a.globals.padHorizontal + a.globals.gridWidth / e, f = a.globals.gridHeight, x = 0, b = 0; x < e; x++, b++) {
            ...
            key: "animateLine", value: function (t, e, i) {
                var a = this.w, s = a.config.chart.animations;
        ...
        return a(t, [{
            key: "checkResponsiveConfig", value: function (t) {
                ...
                if (0 !== a.responsive.length) {
                    ...
                    var n = new k({}), r = function () {
                        var t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {},
                            a = s[0].breakpoint, r = window.innerWidth > 0 ? window.innerWidth : screen.width;
                        if (r > a) {
                            var o = w.extendArrayProps(n, i.globals.initialConfig);
                            t = u.extend(o, t), t = u.extend(i.config, t), e.overrideResponsiveOptions(t)
                        } else for (var l = 0; l < s.length; l++) r < s[l].breakpoint && (t = w.extendArrayProps(n, s[l].options), t = u.extend(i.config, t), e.overrideResponsiveOptions(t))
                    };
                    if (t) {
        ...
        return a(t, [{
            ...
            key: "pushExtraColors", value: function (t, e) {
                ...
                if (null === i && (i = "bar" === a.config.chart.type && a.config.plotOptions.bar.distributed || "heatmap" === a.config.chart.type && a.config.plotOptions.heatmap.colorScale.inverse), i && (s = a.globals.series[0].length * a.globals.series.length), t.length < s) for (var n = s - t.length, r = 0; r < n; r++) t.push(t[r])
            }
        }, {
        ...
        return a(t, [{
            key: "getNearestValues", value: function (t) {
                var e = t.hoverArea, i = t.elGrid, a = t.clientX, s = t.clientY, n = t.hasBars, r = this.w,
            ...
            key: "closestInMultiArray", value: function (t, e, i, a) {
                var s = this.w, n = 0, r = null, o = -1;
                s.globals.series.length > 1 ? n = this.getFirstActiveXArray(i) : r = 0;
                var l = a[n][0], h = i[n][0], c = Math.abs(t - h), d = Math.abs(e - l), u = d + c;
                return a.map(function (s, n) {
                    s.map(function (s, l) {
                        var h = Math.abs(e - a[n][l]), g = Math.abs(t - i[n][l]), f = g + h;
        ...
        return a(t, [{
            key: "drawSeriesTexts", value: function (t) {
                var e = t.shared, i = void 0 === e || e, a = t.ttItems, s = t.i, n = void 0 === s ? 0 : s, r = t.j,
                    o = void 0 === r ? null : r, l = this.w;
                void 0 !== l.config.tooltip.custom ? Array.isArray(l.config.tooltip.custom) ? this.handleCustomTooltip({
                    i: n,
                    j: o,
                    isArray: !0
                }) : this.handleCustomTooltip({i: n, j: o, isArray: !1}) : this.toggleActiveInactiveSeries(i);
            ...
            key: "printLabels", value: function (t) {
                var e, i = t.i, a = t.j, s = t.values, n = t.ttItems, r = t.shared, o = this.w, l = s.xVal, h = s.zVal,
                    c = s.xAxisTTVal, d = "", u = o.globals.colors[i];
            ...
            key: "DOMHandling", value: function (t) {
                var e = t.i, i = t.t, a = t.ttItems, s = t.values, n = t.seriesName, r = t.shared, o = t.pColor,
            ...
            key: "getValuesToPrint", value: function (t) {
                var e = t.i, i = t.j, a = this.w, s = this.ctx.series.filteredSeriesX(), n = "", r = null, o = null,
                    l = {series: a.globals.series, seriesIndex: e, dataPointIndex: i, w: a}, h = a.globals.ttZFormatter;
            ...
            key: "handleCustomTooltip", value: function (t) {
                var e = t.i, i = t.j, a = t.isArray, s = this.w, n = this.ttCtx.getElTooltip(),
        ...
        return a(t, [{
            key: "moveXCrosshairs", value: function (t) {
                var e = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : null, i = this.ttCtx,
                    a = this.w, s = i.getElXCrosshairs(), n = t - i.xcrosshairsWidth / 2,
            ...
            key: "moveYAxisTooltip", value: function (t) {
                ...
                var a = parseInt(i.ycrosshairsHidden.getAttribute("y1")), s = e.globals.translateY + a,
            ...
            key: "moveTooltip", value: function (t, e) {
                var i = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : null, a = this.w,
                    s = this.ttCtx, n = s.getElTooltip(), r = s.tooltipRect, o = null !== i ? parseFloat(i) : 1,
            ...
            key: "moveMarkers", value: function (t, e) {
                ...
                if (i.globals.markers.size[t] > 0) for (var s = i.globals.dom.baseEl.querySelectorAll(" .apexcharts-series[data\\:realIndex='".concat(t, "'] .apexcharts-marker")), n = 0; n < s.length; n++) parseInt(s[n].getAttribute("rel")) === e && (a.marker.resetPointsSize(), a.marker.enlargeCurrentPoint(e, s[n])); else a.marker.resetPointsSize(), this.moveDynamicPointOnHover(e, t)
            }
        }, {
            ...
            key: "moveDynamicPointsOnHover", value: function (t) {
                ...
                if (null !== (l = null !== h ? h : a.globals.dom.baseEl.querySelectorAll(".apexcharts-series-markers circle"))) for (var c = 0; c < l.length; c++) {
                    var d = r[c];
                    if (d && d.length) {
                        var u = r[c][t][1];
            ...
            key: "moveStickyTooltipOverBars", value: function (t) {
                var e, i = this.w, a = this.ttCtx,
                    ...
                    o = r ? parseFloat(r.getAttribute("cx")) : 0, l = r ? parseFloat(r.getAttribute("barWidth")) : 0;
        ...
        return a(t, [{
            ...
            key: "newPointSize", value: function (t, e) {
                var i = this.w, a = i.config.markers.hover.size, s = null;
        ...
        return a(t, [{
            ...
            key: "handleHeatTooltip", value: function (t) {
                var e = t.e, i = t.opt, a = t.x, s = t.y, n = this.ttCtx, r = this.w;
            ...
            key: "handleMarkerTooltip", value: function (t) {
                ...
                if (a.target.classList.contains("apexcharts-marker")) {
                    var h = parseInt(s.paths.getAttribute("cx")), c = parseInt(s.paths.getAttribute("cy")),
            ...
            key: "handleBarTooltip", value: function (t) {
                var e, i, a = t.e, s = t.opt, n = this.w, r = this.ttCtx, o = r.getElTooltip(), l = 0, h = 0, c = 0,
            ...
            key: "getBarTooltipXY", value: function (t) {
                var e = t.e, i = t.opt, a = this.w, s = null, n = this.ttCtx, r = 0, o = 0, l = 0, h = 0, c = 0,
        ...
        return a(t, [{
            ...
            key: "drawYaxisTooltipText", value: function (t, e, i) {
                ...
                if (a.blyaxisTooltip) {
                    var r = a.getElGrid().getBoundingClientRect(), o = (e - r.top) * i.yRatio[t],
        ...
        return a(t, [{
            ...
            key: "drawFixedTooltipRect", value: function () {
                var t = this.w, e = this.getElTooltip(), i = e.getBoundingClientRect(), a = i.width + 10,
                    s = i.height + 10, n = this.tConfig.fixed.offsetX, r = this.tConfig.fixed.offsetY;
            ...
            key: "seriesHoverByContext", value: function (t) {
                var e = t.chartCtx, i = t.ttCtx, a = t.opt, s = t.e, n = e.w, r = this.getElTooltip();
                (i.tooltipRect = {
                    x: 0,
                    y: 0,
            ...
            key: "axisChartsTooltips", value: function (t) {
                var e, i, a, s = t.e, n = t.opt, r = this.w, o = null, l = n.elGrid.getBoundingClientRect(),
                    h = "touchmove" === s.type ? s.touches[0].clientX : s.clientX,
                    c = "touchmove" === s.type ? s.touches[0].clientY : s.clientY;
                if (this.clientY = c, this.clientX = h, r.globals.capturedSeriesIndex = -1, r.globals.capturedDataPointIndex = -1, c < l.top || c > l.top + l.height) this.handleMouseOut(n); else {
            ...
            key: "nonAxisChartsTooltips", value: function (t) {
                var e = t.e, i = t.opt, a = t.tooltipRect, s = this.w, n = i.paths.getAttribute("rel"),
                    r = this.getElTooltip(), o = s.globals.dom.elWrap.getBoundingClientRect();
            ...
            key: "create", value: function (t, e, i, a, s) {
                ...
                if (r.config.legend.tooltipHoverFormatter) {
                    var c = r.config.legend.tooltipHoverFormatter, d = Array.from(this.legendLabels);
                    d.forEach(function (t) {
                        var e = t.getAttribute("data:default-text");
                        t.innerHTML = decodeURIComponent(e)
                    });
                    for (var u = 0; u < d.length; u++) {
                        var g = d[u], f = parseInt(g.getAttribute("i")),
                            x = decodeURIComponent(g.getAttribute("data:default-text")),
                            b = c(x, {seriesIndex: n ? f : i, dataPointIndex: a, w: r});
                        if (n) g.innerHTML = r.globals.collapsedSeriesIndices.indexOf(f) < 0 ? b : x; else if (g.innerHTML = f === i ? b : x, i === f) break
                    }
                }
                if (n) {
        ...
        return a(t, [{
            ...
            key: "zoomUpdateOptions", value: function (t, e) {
                ...
                s && (a = s.xaxis);
                var n = {xaxis: a}, r = u.clone(i.globals.initialConfig.yaxis);
        ...
        return o(i, mt), a(i, [{
            ...
            key: "drawSelectionRect", value: function (t) {
                var e = t.x, i = t.y, a = t.width, s = t.height, n = t.translateX, r = t.translateY, o = this.w,
            ...
            key: "selectionDrawing", value: function (t) {
                var e = t.context, i = t.zoomtype, a = this.w, s = e, n = this.gridRect.getBoundingClientRect(),
                    r = s.startX - 1, o = s.startY, l = s.clientX - n.left - r, h = s.clientY - n.top - o, c = 0, d = 0,
                    u = {};
            ...
            key: "selectionDragging", value: function (t, e) {
                var i = this, a = this.w, s = this.xyRatios, n = this.selectionRect, r = 0;
            ...
            key: "selectionDrawn", value: function (t) {
                var e = t.context, i = t.zoomtype, a = this.w, s = e, n = this.xyRatios, r = this.ctx.toolbar;
                if (s.startX > s.endX) {
                    var o = s.startX;
                ...
                var h = a.globals.xAxisScale.niceMin + s.startX * n.xRatio,
                    c = a.globals.xAxisScale.niceMin + s.endX * n.xRatio, d = [], g = [];
                if (a.config.yaxis.forEach(function (t, e) {
                    ...
                    var f = u.clone(a.globals.initialConfig.yaxis), p = {min: h, max: c};
            ...
            key: "panDragging", value: function (t) {
                ...
                if (void 0 !== a.globals.lastClientPosition.x) {
                    var n = a.globals.lastClientPosition.x - s.clientX, r = a.globals.lastClientPosition.y - s.clientY;
            ...
            key: "panScrolled", value: function (t, e, i) {
                var a = this.w, s = this.xyRatios, n = u.clone(a.globals.initialConfig.yaxis);
    ...
    nt = "undefined" != typeof window ? window : void 0, rt = function (e, i) {
        ...
        a.PathArray = function (t, e) {
            ...
            toString: function () {
                ...
                var n = [], r = new a.Point, o = new a.Point, l = 0, c = t.length;
                do {
            ...
            attr: function (e, i, a) {
                ...
                if ("object" === t(e)) for (var a in e) this.style(a, e[a]); else this.add(e, i, "styles");
                return this
            }, x: function (t, e) {
            ...
            }, inherit: a.Box, parent: a.Element, extend: {
                addOffset: function () {
            ...
            transform: function (e, i) {
                ...
                if (s = new a.Matrix(this), i = !!i || !!e.relative, null != e.a) s = i ? s.multiply(new a.Matrix(e)) : new a.Matrix(e); else if (null != e.rotation) x(e, this), s = i ? s.rotate(e.rotation, e.cx, e.cy) : s.rotate(e.rotation - s.extract().rotation, e.cx, e.cy); else if (null != e.scale || null != e.scaleX || null != e.scaleY) {
            ...
            create: function (e) {
                ...
                if (e instanceof a.Element) {
                    for (l = e, h = e, o = (e.attr("viewBox") || "").match(u), e.bbox, n = new a.Number(e.width()), r = new a.Number(e.height()); "%" == n.unit;) c *= n.value, n = new a.Number(l instanceof a.Doc ? l.parent().offsetWidth : l.parent().width()), l = l.parent();
                    for (; "%" == r.unit;) d *= r.value, r = new a.Number(h instanceof a.Doc ? h.parent().offsetHeight : h.parent().height()), h = h.parent();
            ...
            var r = i.bind(s || t.instance || t), o = (a.handlerMap.indexOf(t) + 1 || a.handlerMap.push(t)) - 1,
            ...
            var s = a.handlerMap.indexOf(t), n = e && e.split(".")[0], r = e && e.split(".")[1], o = "";
            if (-1 != s) if (i) {
            ...
            } else if (r) for (e in a.listeners[s]) for (o in a.listeners[s][e]) r === o && a.off(t, [e, r].join(".")); else if (n) {
                if (a.listeners[s][n]) {
            ...
            create: function (t, e) {
                if (this.constructor.call(this, a.create(t)), e) for (var i in e.prototype) "function" == typeof e.prototype[i] && (this[i] = e.prototype[i])
            }, inherit: a.Element, extend: {
                words: function (t) {
                    for (; this.node.hasChildNodes();) this.node.removeChild(this.node.lastChild);
            ...
            parent: a.Text,
            construct: {
                morphArray: a.PathArray, path: function (t) {
            ...
            create: "a", inherit: a.Container, extend: {
                to: function (t) {
            ...
            create: "marker", inherit: a.Container, extend: {
                width: function (t) {
        ...
        return function (t) {
            ...
            t.requestAnimationFrame = t.requestAnimationFrame || function (e) {
                var a = (new Date).getTime(), s = Math.max(0, 16 - (a - i)), n = t.setTimeout(function () {
                    e(a + s)
                }, s);
                return i = a + s, n
    ...
    } : nt.SVG = rt(nt, nt.document), function () {
        ...
        function a(t) {
            ...
            switch (t[0]) {
                ...
                case"A":
                    t = (e = function (t, e) {
                        var i, a, s, n, r, o, l, h, c, d, u, g, f, p, x, b, m, v, y, w, k, A, S, C, L, P,
                            z = Math.abs(e[1]), E = Math.abs(e[2]), M = e[3] % 360, T = e[4], I = e[5], X = e[6],
                            Y = e[7], F = new SVG.Point(t), R = new SVG.Point(X, Y), D = [];
        ...
        t.prototype.init = function (t, e) {
            ...
            var e = this.getBBox(), i = this.transformPoint(t),
                ...
                s = this.startPoints.box.y + i.y - this.startPoints.point.y, n = this.constraint,
        ...
        (function () {
            ...
            t.prototype.transformPoint = function (t, e, i) {
                ...
                var i = t.slice(), a = this.parameters.box.width / this.parameters.box.height,
                    s = this.parameters.box.width + t[0], n = this.parameters.box.height - t[1], r = s / n;
    ...
    return function (t, e) {
        ...
        if ("Element" in t) {
            var e = t.Element.prototype, i = Object, a = String.prototype.trim || function () {
            ...
            if (n.prototype = Error.prototype, l.item = function (t) {
                ...
                var i = this.contains(t), a = i ? !0 !== e && "remove" : !1 !== e && "add";
        ...
        "replace" in document.createElement("_").classList || (DOMTokenList.prototype.replace = function (t, e) {
            var i = this.toString().split(" "), a = i.indexOf(t + "");
        ...
        var i, a,
            ...
            n = (a = window.cancelAnimationFrame || window.mozCancelAnimationFrame || window.webkitCancelAnimationFrame || window.clearTimeout, function (t) {
                return a(t)
            }), r = !1, o = "animationstart", l = "Webkit Moz O ms".split(" "),
            h = "webkitAnimationStart animationstart oAnimationStart MSAnimationStart".split(" "),
            c = document.createElement("fakeelement");
        if (void 0 !== c.style.animationName && (r = !0), !1 === r) for (var d = 0; d < l.length; d++) if (void 0 !== c.style[l[d] + "AnimationName"]) {
            o = h[d];
            break
        }
        ...
        return a(i, [{
            ...
            key: "mount", value: function () {
                ...
                return new Q(function (a, s) {
                    ...
                    if ((null === t || i.globals.allSeriesCollapsed) && e.series.handleNoData(), e.annotations = new m(e), e.core.drawAxis(i.config.chart.type, t.xyRatios), e.grid = new lt(e), "back" === i.config.grid.position && e.grid.drawGrid(), "back" === i.config.annotations.position && e.annotations.drawAnnotations(), t.elGraph instanceof Array) for (var n = 0; n < t.elGraph.length; n++) i.globals.dom.elGraphical.add(t.elGraph[n]); else i.globals.dom.elGraphical.add(t.elGraph);
            ...
            key: "_updateOptions", value: function (e) {
                var i = arguments.length > 1 && void 0 !== arguments[1] && arguments[1],
                    ...
                    n = arguments.length > 4 && void 0 !== arguments[4] && arguments[4], r = [this];
