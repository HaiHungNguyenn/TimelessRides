      ...
      options: {
        ...
        scales: {
          ...
          yAxes: [
            {
              display: true,
              ticks: { max: 400, stepSize: 100, min: 0 },
              gridLines: { display: true, drawBorder: false },
  ...
  (function ($) {
    ...
    new Chart(ctx, {
      ...
      options: {
        ...
        legend: { labels: { usePointStyle: true, fontFamily: "Montserrat" } },
        scales: {
          xAxes: [
            {
              display: true,
          ...
          yAxes: [
            {
              ...
              gridLines: { display: false, drawBorder: false },
              scaleLabel: { display: true, labelString: "Value" },
              ticks: { max: 200, min: 0, stepSize: 20 },
            },
          ],
        },
  ...
  (function ($) {
    ...
    new Chart(ctx, {
      ...
      options: {
        ...
        scales: {
          xAxes: [{ display: false }],
          yAxes: [{ ticks: { max: 100, stepSize: 10, min: 0 } }],
        },
      },
    });
  })(jQuery);
